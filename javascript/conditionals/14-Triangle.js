// Write a program that reads three numbers and tells you if the numbers can be the sides
// of a triangle (the sum of two sides must always be greater than the third side).
